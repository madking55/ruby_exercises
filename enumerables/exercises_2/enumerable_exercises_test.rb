...
class EnumerablesTest < Minitest::Test
  ...
  def test_normalize_zip_codes
    ...
    actual = numbers.map { |number| number.to_s.rjust(5, '0') }
  ...
  def test_pick_floats
    ...
    actual = numbers.select { |number| number.is_a?(Float) }
  ...
  def test_array_with_the_most_items
    ...
    actual = arrays.max_by { |arr| arr.length }
  ...
  def test_has_a_multi_word_phrase
    ...
    actual = phrases.any? { |word| word.include?(' ') }
    assert_equal true, actual
  end
  ...
  def test_most_programmers
    ...
    actual = programmers.max_by { |lang| lang[0]  }
  ...
  def test_multiply_list_of_numbers
    numbers = [2, 3, 5, 7]
    # initial value is 1
    actual = numbers.reduce(1) { |product, num| product * num }
  ...
  def test_sort_by_number_of_cents
    ...
    actual = prices.sort_by { |num| num % 1 }
  ...
  def test_remove_hashes
    ...
    actual = elements.reject { |e| e.is_a?(Hash) }
  ...
  def test_capitalize_keywords_in_phrase_one_fish_two_fish_red_fish_blue_fish
    ...
    actual = keywords.reduce('one fish two fish red fish blue fish') do |phrase, word|
  ...
  def test_subtract_smallest_values_from_100
    ...
    actual = elements.reduce(100) { |difference, num| difference - num.min }
    assert_equal 88, actual
  end

  def test_one_double_digit_number
    numbers = [8, 2, 10, 333, 9, 101]
    actual = numbers.one? { |num| num.digits.size == 2 }
    assert actual
  end
